...
class ProductsView extends GetResponsiveView {
  ...
  Container _buildCardProduct(ProductsModel product) {
    return Container(
      height: 140.h,
      width: 320.w,
      ...
      child: Row(children: [
        Expanded(flex: 2, child: _buildCardProductLeft(product)),
        Expanded(
          flex: 3,
          child: _buildCardProductRight(product),
        ),
      ]),
    );
  }

  Padding _buildCardProductRight(ProductsModel product) {
    return Padding(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  ...
                  fontFamily: 'Inter',
                  fontSize: productController.isTablet.isTrue ? 15.sp : 12.sp,
              ...
              Flexible(
                child: Text(
                  ...
                  style: TextStyle(
                    color: CustomColor.black,
                    fontFamily: 'Inter',
                    fontSize: productController.isTablet.isTrue ? 13.sp : 12.sp,
  ...
  Container _buildCardProductLeft(ProductsModel product) {
    return Container(
      decoration: BoxDecoration(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              color: CustomColor.black,
              fontFamily: 'Inter',
              fontSize: productController.isTablet.isTrue ? 24.sp : 16.sp,
              fontWeight: FontWeight.w700,
            ),
          ),
        ],
